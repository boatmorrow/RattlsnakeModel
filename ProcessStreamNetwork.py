...
#calculate stream networks and cascades
...
#Load Data
#######################################################
# load model grid, dem, flow directions, and flow accumulation
